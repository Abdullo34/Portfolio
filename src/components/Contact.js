...
function Contact() {
    return (
        <div className='w-full  bg-gradient-to-b from-black to-gray-800 p-4 text-white h-fit-content'>
            <div className='flex flex-col p-4 justify-center max-w-screen mx-auto h-full'>

                <div className='pb-8  lg:ml-[40px]'>
                    <p className='text-4xl font-bold inline border-b-4 border-gray-500'>Contact</p>
                    <p className='py-6'>Submit the form below to get in touch with me</p>
                </div>

                <div className='flex justify-center items-center'>
                    <form action="https://formsubmit.co/your@email.com" method="POST" className='flex flex-col w-full md:w-1/2'>
                        <input type="text" name='name' placeholder='enter your name' className='p-2 bg-transparent border-2  rounded-md text-white focus:outline-none' />


                        <input type="email" name='email' placeholder='enter your email' className='p-2 bg-transparent my-4  border-2  rounded-md text-white focus:outline-none' />
