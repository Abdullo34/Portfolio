...
function Singlepage() {
  ...
  return (
    <div className='w-full   xl:h-screen border border-black bg-gradient-to-b from-black  to-gray-800 text-white   flex justify-center lg:items-center '>
      <div className='absolute top-[20px]  w-[95%] flex justify-end lg:top-[10px] xl:top-[40px] '>
        <Link to='/portfolio'> <img className='w-[20px] sm:w-[30px]' src={img_1} alt="" /> </Link>
      </div>
      <div className='w-[90%]  border border-red-400 my-[20px] lg:my-[40px] lg:flex translate-y-[50px] lg:translate-y-0 xl:my-[20px] '>
        <div className='w-full  border border-blue-400 lg:w-[60%] '>
          <img className='w-full  h-[170px] sm:h-[300px] md:h-[400px] lg:h-[350px] xl:h-[450px]' src={item.image} alt="" />
        </div>


        {/* information  */}
        <div className='w-full border border-black lg:w-[40%] lg:pl-[15px] '>
          <div className='my-[10px] pl-2 sm:h-[130px] sm:flex sm:flex-col border border-white sm:justify-evenly  xl:h-[180px]'>
          ...
          <div className=' flex justify-between sm:w-[50%] md:w-[42%] lg:w-[50%]  lg:h-[60px] lg:items-center '>
            <button type="button" class=" w-[130px] h-[40px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Result</button>
          ...
          <div className='w-full pl-2 py-[15px] sm:w-[50%] lg:w-[70%] lg:py-[10px] '>
            ...
            <div className='flex justify-around items-center py-[10px] h-[60px] w-[80%]'>
              ...
              <a className='text-[30px]  hover:text-red-500' href=""><FaGithub /></a>
